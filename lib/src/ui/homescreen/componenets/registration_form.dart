                                ...
                                child: RichText(
                                  text: TextSpan(
                                    ...
                                    children: [
                                      ...
                                      TextSpan(
                                          text:
                                              "⚡ 🏆 মূল টুর্নামেন্ট: ০৭ নভেম্বর - ১২ ডিসেম্বর, ২০২৫🎯 প্লেয়ার নির্বাচন প্রক্রিয়াপ্রতিটি দল নিলামের মাধ্যমে লোকাল ও সেমি-লোকাল প্লেয়ারদের মধ্য থেকে পছন্দের খেলোয়াড়দের দলে অন্তর্ভুক্ত করতে পারবে।📝 রেজিস্ট্রেশন করার নিয়মধাপ ১: এই 01327-641252 (Fahim Traders) নম্বরে নি‍র্ধারিত রেজিস্ট্রেশন ফি bKash থেকে পেমেন্ট করুন এবং ট্রানজেকশন আইডি সংরক্ষণ করুন।ধাপ ২: 🔗 রেজিস্ট্রেশন লিংকে গিয়ে সকল তথ্য সঠিকভাবে পূরণ করুন।ধাপ ৩: ✅ রেজিস্ট্রেশন সম্পূর্ণ হলে আপনার ডাটার একটি ইমেজ পাবেন যা Screenshot/ডাউনলোড করতে পারবেন। (ডাউনলোড না হলে Screenshot নিন)ধাপ ৪: 📸 ডাউনলোডকৃত ইমেজটি দিয়ে আপনার অনুভূতি DPL Fan Arena  গ্রুপে পোস্ট করুন ",
                                          style: TextStyle(
                                            fontSize: 16,
                                            fontFamily: 'Roboto',
                                          )),
                                      ...
                                      TextSpan(
                                        text:
                                            ' 🔗 রেজিস্ট্রেশন লিংক: https://dplt10.org/',
                                        style: TextStyle(
                                          color: Colors.blue,
                                          decoration: TextDecoration.underline,
                                        ),
